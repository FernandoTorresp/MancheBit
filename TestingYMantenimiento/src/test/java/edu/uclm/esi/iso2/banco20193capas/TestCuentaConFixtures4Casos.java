...
/**
 * The Class TestCuentaConFixtures4Casos.
 */
...
public class TestCuentaConFixtures4Casos extends TestCase {
    ...
    public void setUp() {
        ...
        try {
            ...
            this.tcPepe =
                    this.cuentaPepe.emitirTarjetaCredito(pepe.getNif(), 2000);
            this.tcAna =
                    this.cuentaAna.emitirTarjetaCredito(ana.getNif(), 10000);
    ...
    public void testTransferencia() {
        try {
            this.cuentaPepe.transferir(this.cuentaAna.getId(), 500,
                    "Alquiler");
    ...
    /**
     * Test compra por internet con TC.
     */
    @Test
