...
/**
* La clase Cuenta representa una cuenta bancaria, que ha de tener al menos un Cliente que sea titular.
* 
* 
*/
@Entity
public class Cuenta {
	 ...
	 * @throws ImporteInvalidoException	Si el importe es menor o igual 0
	 * @throws SaldoInsuficienteException	Si el importe es mayor a getSaldo()
	 */
